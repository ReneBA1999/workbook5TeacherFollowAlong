...
// Find the selected Saiyan object
  ...
  // <label for="saiyanDropdown">Choose a Saiyan:</label>
  // <select id="saiyanDropdown"></select>
  // <button id="showDetailsBtn">Show Selected Saiyan</button>
  // <p id="saiyanDetails"></p>




let selectSaiyan = document.getElementById('saiyanDropdown');
        selectSaiyan.addEventListener('click', function ()
        {
            let newslectedsaiyan = document.createElement('div');
            newslectedsaiyan .className = '.saiyans';
            newslectedsaiyan .textContent = 'saiyanDropdown';
            document.body.appendChild(newslectedsaiyan );
        });

        const dropdown = document.getElementById('saiyanDropdown');
        let fragment = document.createDocumentFragment();

        saiyans.forEach(saiyan => {
            const option = document.createElement('option');
            option.value = saiyan.poweLevel;
